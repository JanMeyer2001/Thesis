...
\begin{figure}[htpb]
	...
	\caption{Images corrupted with simulated lung motion for the same cardiac frame.}
...
\begin{figure}[htpb]
	\centering
	\includegraphics[width=\linewidth]{./Images/ReconstructionPipelineEvaluation.png} 
